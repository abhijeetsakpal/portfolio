...
export const offers: Array<{
  ...
  {
    badge: "Quick start",
    title: "Website or Small Web App",
    pitch:
      "Marketing website, landing page, internal tool, or small CRUD app — built in Angular + .NET Core + SQL Server (or simpler stack if it fits). Clean code, deployed live, yours to keep.",
    duration: "1–3 weeks",
    priceUsd: "Starting at $300",
    priceInr: "≈ ₹25,000",
    deliverables: [
      "Discovery call + written scope before any code",
      "Responsive design (mobile, tablet, desktop)",
      "Up to 5–8 pages or screens, content-managed where useful",
      "SQL Server schema + basic admin/CRUD if app-style",
      "Forms, contact, basic auth if needed",
      "Deployed live (Azure App Service / IIS / Vercel — your call)",
      "Source code + simple README handover",
      "14 days of free bug-fix support after launch",
    ],
    bestFor:
      "Small businesses, freelancers, and teams who need a clean, functional web presence or a focused internal tool — without enterprise overhead.",
    cta: "Get a quote",
  },
  {
    badge: "Most popular",
    ...
    pitch:
      "Full-featured business application built on Angular + .NET Core + SQL Server. Dashboards, role-based access, reports, integrations — scales from medium to large with the same architecture.",
    duration: "3–10 weeks",
    priceUsd: "Starting at $900",
    priceInr: "≈ ₹75,000",
    deliverables: [
      "Discovery + written PRD with milestones and timeline",
      "Database design — schema, stored procedures, indexes, query tuning",
      ".NET Core Web API with clean architecture and role-based auth",
      "Angular front-end with dashboards, forms, and admin screens",
      "Third-party integrations (payment, email, SMS, ERP, etc.)",
      "Deployed to Azure / IIS with CI/CD setup",
      "Weekly demo + one review call each week",
      "Source code, API docs, runbook, and 30-day bug-fix support",
    ],
    bestFor:
